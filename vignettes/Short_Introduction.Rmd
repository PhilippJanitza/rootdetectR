...
`rootdetectR` can perfome several ANOVA + Tukey post-hoc analysis and print the p-values as matrix plots in pdf files. You can change the name of output pdfs by setting the arguments file or file_base.
