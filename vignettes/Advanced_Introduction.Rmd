...
All ANOVA Analysis can be used adjusted to non Rootdetection data sets by adjusting  `col_grouping1`, `col_grouping2` and `col_value` to define grouping and dependent variables.
