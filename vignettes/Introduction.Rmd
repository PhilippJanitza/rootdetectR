...
With `rootdetectR` it is possible to add statistics to this plots using Letter encoding If `plot_significance` is set to TRUE.
...
To add statistics to this plot set `plot_significance = T`.
