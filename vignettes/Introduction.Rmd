...
Detailed manual for `rootdetectR` version 0.0.09005.
...
This first developmental version is only limited in customizability of the plots. The availability of more features is the main focus for future releases.
...
4. Possibility to have other Length standards
4. Function to remove outlier from data set - done!
...
8. Add internal testing to the package
