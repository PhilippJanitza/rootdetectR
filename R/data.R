...
#'
#' A dataset containing measured A. thaliana wild-type (Col-0) and mutant (tir1_1afb2_3, weitar1_1, yucOx) seedling hypocotyls and a 10mm length standard in colum LengthPx.
#'
